...
def cmd_WATCH(self, localServer, recv):
    ### -> irc2.chattersweb.nl WATCH C +MelkBaazz +MelkBaazzz +MellowGurl +Mr_Me
    ### -> irc2.chattersweb.nl WATCH +MrThunder +Y4kuzi +Yakuzi +Yosi +yosique +ZoeyDeutch S
