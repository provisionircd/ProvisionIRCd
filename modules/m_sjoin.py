...
def sjoin(self, localServer, recv):
    try:
        ...
        for member in memberlist:
            ...
            if not userClass:
                _print('{}ERROR: could not fetch userclass for remote user {}. Looks like the user did not sync correctly. Maybe nick collision?{}'.format(R, membernick, W), server=localServer)
                continue
