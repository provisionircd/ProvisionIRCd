...
class ConfigParser:
    ...
    def __init__(self, conf_path):  # =IRCD.rootdir + "/conf/ircd.conf"):
        ...
        self.directive_tree = None
        self.bracket_warn = None
        self.semicolon = None
        self.got_bracket_data = None
        self.closing_count = None
        self.opening_count = None
        self.in_quoted_string = None
        self.BLOCK_VALUE = None
        self.READING_BLOCK_NAME = None
        self.BLOCK_NAME = None
        self.multi_line_comment_check_for_end = None
        self.multi_line_comment = None
        self.multi_line_comment_check = None
        self.single_line_comment_check = None
